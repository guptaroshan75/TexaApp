...
interface CustomeEditShowModel {
    lable: any,
    responses: any,
    loading: any,
...
const CustomeEditShowModel: React.FC<CustomeEditShowModel> = ({
    responses, loading, setSelectedValue, placeholder, lable, selectedShowValue
}) => {
    ...
    useEffect(() => {
        if (selectedShowValue) {
            setSelectedItem(selectedShowValue.name);
        }
    }, [selectedShowValue]);;
...
export default CustomeEditShowModel
