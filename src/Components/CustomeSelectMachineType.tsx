...
interface CustomeSelectMachineType {
    responses: any,
    lable: any,
    loading: any,
...
const CustomeSelectMachineType: React.FC<CustomeSelectMachineType> = ({
    responses, loading, lable, placeholder, setSelectedValue
}) => {
...
export default CustomeSelectMachineType
